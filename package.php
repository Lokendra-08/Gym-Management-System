...
<body>
    ...
    <?php 
        ...
        $sql ="SELECT id, titlename, PackageType, PackageDuratiobn, Price, Description, create_date from tbladdpackage";
        $query= $dbh -> prepare($sql);
        $query-> execute();
    ...
    ?>
					...
					<div class="pack1">
						...
						<?php else :?>
							<!-- <a href="#" class="site-btn sb-line-gradient">Book Now</a> -->
							 <form method='post'>
