...
$titlename = $_POST['titlename'];$package = $_POST['package'];$packageduratiobn = $_POST['packageduratiobn'];$Price = $_POST['Price'];$description = $_POST['description'];

$sql="INSERT INTO tbladdpackage (titlename,PackageType,PackageDuratiobn,Price,Description) 
Values(:titlename,:package,:packageduratiobn,:Price,:description)";
            ...
            <div class="tile-body">
              <form class="row" method="post">
                 ...
                 <div class="form-group col-md-6">
                  ...
                  <?php 
                  $stmt = $dbh->prepare("SELECT * FROM tblpackage ORDER BY PackageName");
                  $stmt->execute();
