...
--
-- Table structure for table `tbladdtrainer`
--

CREATE TABLE `tbladdtrainer` (
  `id` int(10) NOT NULL,
  `tran_name` varchar(20) DEFAULT NULL,
  `tran_class` varchar(30) DEFAULT NULL,
  `tran_contact` varchar(10) DEFAULT NULL,
  `tran_image` blob,
...
INSERT INTO `tbladdtrainer` (`id`, `tran_name`, `tran_class`, `tran_contact`,`tran_image`,`create_date`) VALUES
(1, 'Ali', 'Barbell hip thrust', '1234567890','load_file(C:\\xampp\\htdocs\\project\\gym_main\\admin\\img\\trainer1.jpg)','2022-03-05 02:55:34'),
(2, 'Mohsin', 'Bench Press', '1122334455','load_file(C:\\xampp\\htdocs\\project\\gym_main\\admin\\img\\trainer2.jpg)','2022-03-05 02:56:44');
...
INSERT INTO `tbladdpackage` (`id`, `titlename`, `PackageDuratiobn`, `Price`, `Description`, `create_date`) VALUES
(1, 'Free Fitness Gear Package', '3 Month', '600', 'Free Fitness Gear\nComplimentary OnePass', '2022-03-05 02:55:34'),
(2, '3 Months Membership Package', '6 Month', '800', 'Book Six Days Different Trainers Class designed for fast Weight Loss / Weight Gain with combination of Latest Workouts in addition to complimentary access to gym area with personal training.', '2022-03-05 02:56:44');
...
INSERT INTO `tblpackage` (`id`, `PackageName`) VALUES
(1, 'Package1'),
(3, 'Package2');
...
--
-- Indexes for table `tbladdtrainer`
--
ALTER TABLE `tbladdtrainer`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbladdtrainer`
--
ALTER TABLE `tbladdtrainer`
